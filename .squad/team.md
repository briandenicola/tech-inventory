...
- **Testing:** xUnit, Vitest + Testing Library, real-HTTP integration tests (in-process SQLite), axe-core, Lighthouse CI. Browser-automation E2E is retired — `specs/004-agentic-development-foundation/brief.md` §2.1.
