...
<svelte:head>
	<title>{t('tags.list.title')} — {t('app.title')}</title>
</svelte:head>
...
<div class="-mt-8">
	...
	{:else if tags.length === 0}
		<div class="mt-6">
			<EmptyState message={t('tags.list.emptyState')} showAddAction={false} />
		</div>
	{:else}
					...
					<div class="grid grid-cols-8 gap-2">
						{#each TAG_PRESET_COLORS as presetColor}
							<button
								...
								class="h-11 w-full rounded-md border-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2"
